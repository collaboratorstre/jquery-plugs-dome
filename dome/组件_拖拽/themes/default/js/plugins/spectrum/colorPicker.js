 ...
 * @param initColor
 */
function colorInitial(elementId, initColor) {
	console.log(elementId + "," + initColor);
	//alert(elementId);
	if (typeof (initColor) == "undefined" || initColor == "") {
		initColor = "none";
	}
	$("#" + elementId).spectrum(
		{
			allowEmpty : true,
			color : initColor, // "#d9d9d9", //页面的初始颜色
			showInput : true,
			...
			palette : [
				...
				[ "rgb(230, 184, 175)", "rgb(244, 204, 204)", "rgb(252, 229, 205)", "rgb(255, 242, 204)", "rgb(217, 234, 211)", "rgb(208, 224, 227)",
					...
					"rgb(133, 32, 12)", "rgb(153, 0, 0)", "rgb(180, 95, 6)", "rgb(191, 144, 0)", "rgb(56, 118, 29)", "rgb(19, 79, 92)",
					"rgb(17, 85, 204)", "rgb(11, 83, 148)", "rgb(53, 28, 117)", "rgb(116, 27, 71)",
